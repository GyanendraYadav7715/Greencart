const ContactUs = () => {
  return (
    <form class="flex flex-col items-center text-sm text-slate-800 h-[70vh] py-24">
      <p class="text-xs bg-primary/10 text-primary font-medium px-3 py-1 rounded-full">
        Contact Us
      </p>
      ...
      <div class="max-w-96 w-full px-4">
        ...
        <div class="flex items-center mt-2 mb-4 h-10 pl-3 border border-slate-300 rounded-full focus-within:ring-2 focus-within:ring-primary transition-all overflow-hidden">
          <svg
            width="20"
            height="20"
            viewBox="0 0 20 20"
        ...
        <label for="email-address" class="font-medium mt-4">
          Email Address
        </label>
        <div class="flex items-center mt-2 mb-4 h-10 pl-3 border border-slate-300 rounded-full focus-within:ring-2 focus-within:ring-primary transition-all overflow-hidden">
          <svg
        ...
        <label for="message" class="font-medium mt-4">
          Message
        </label>
        <textarea
          rows="4"
          class="w-full mt-2 p-2 bg-transparent border border-slate-300 rounded-lg resize-none outline-none focus:ring-2 focus-within:ring-primary transition-all"
        ...
        <button
          type="submit"
          class="flex items-center justify-center gap-1 mt-5 bg-primary hover:bg-primary-dull text-white py-2.5 w-full rounded-full transition"
        >
          Submit Form
          <svg
            class="mt-0.5"
